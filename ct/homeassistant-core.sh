#!/usr/bin/env bash
source <(curl -s https://raw.githubusercontent.com/cghdev/ProxmoxVE/main/misc/build.func)
...
function update_script() {
  ...
  if ! lsb_release -d | grep -q "Ubuntu 24.10"; then
    ...
    msg_error "Read Guide: https://github.com/cghdev/ProxmoxVE/discussions/1549"
    exit 1
  fi
